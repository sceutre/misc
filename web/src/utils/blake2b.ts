...
export function blake2b(input: Uint8Array, key?: Uint8Array, outlen: number = 64) {
...
export function blake2b_init(outlen: number, key?: Uint8Array): Blake2B {
...
export function blake2b_update(ctx: Blake2B, input: Uint8Array) {
