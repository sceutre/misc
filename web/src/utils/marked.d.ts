...
export namespace marked {
    ...
    class Tokenizer<T = never> {
        ...
        autolink(this: Tokenizer & TokenizerThis, src: string): Tokens.Link | T;
        url(this: Tokenizer & TokenizerThis, src: string): Tokens.Link | T;
        inlineText(this: Tokenizer & TokenizerThis, src: string): Tokens.Text | T;
    }
